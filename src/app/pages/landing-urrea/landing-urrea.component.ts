...
@Component({
  ...
  templateUrl: './landing-urrea.component.html',
  styleUrl: './landing-urrea.component.scss',
})
export class LandingUrreaComponent implements OnInit, AfterViewInit, OnDestroy {
  private fragmentSub: Subscription | undefined;

  /* =========================================================================
     CONFIGURACIÓN DE MARCA URREA
     ========================================================================= */
  protected config: LandingConfig = {
    ...
    hero: {
      title:
        'HERRAMIENTAS <br> <span class="text-outline">INDUSTRIALES</span> <br> <span class="text-red">URREA</span>',
      subtitle: 'Expertos en calidad y seguridad.',
      desktopImage: 'assets/brand/urrea/logos-urrea/banner-desktop.webp',
      mobileImage: 'assets/brand/urrea/logos-urrea/banner-mobile.webp',
      imageAlt: 'Herramientas profesionales URREA en Mersol Sureste',
      primaryCtaText: 'VER CATÁLOGO',
      secondaryCtaText: 'CONTACTO',
      catalogUrl: 'https://medios.urrea.com/catalogo/ListasDePrecios/2025/CDP25.pdf',
      whatsappUrl:
        'https://wa.me/529939805654?text=Hola%20Mersol!%20Vengo%20de%20su%20p%C3%A1gina%20URREA.%20Me%20interesa%20informaci%C3%B3n%20sobre%20sus%20herramientas.',
      whatsappMessage:
        'Hola Mersol! Vengo de su página URREA. Me interesa información sobre sus productos y servicios.',
      stats: {
        value: '+18',
    ...
    business: {
      ...
      brandLogoNavbar: 'assets/brand/urrea/logos-urrea/URREA.svg',
    ...
    seo: {
      ...
      description:
        'Distribuidor autorizado URREA en el sureste mexicano. Expertos en soluciones totales para la industria y el mantenimiento: herramientas de mano, neumáticas, diagnóstico y más.',
    ...
    banner: {
      tagline: 'DISTRIBUIDOR AUTORIZADO URREA',
      promos: [
        {
          id: 1,
          titulo: 'URREA - Herramientas de Mano',
          imgDesktop: 'assets/brand/urrea/promo-urrea/promoH0.webp',
          imgMobile: 'assets/brand/urrea/promo-urrea/promoV0.webp',
    ...
    categories: [
      {
        ...
        image: 'assets/brand/urrea/categories-urrea/01.webp',
        link: 'https://mersolsureste.com.mx/tienda?search=URREA',
      },
      {
        title: 'ORGANIZACIÓN Y ALMACENAMIENTO',
        image: 'assets/brand/urrea/categories-urrea/02.webp',
        link: 'https://mersolsureste.com.mx/tienda?search=URREA',
      },
      {
        title: 'HERRAMIENTAS NEUMÁTICAS',
        image: 'assets/brand/urrea/categories-urrea/03.webp',
        link: 'https://mersolsureste.com.mx/tienda?search=URREA',
      },
      {
        title: 'EQUIPOS DE DIAGNÓSTICO',
        image: 'assets/brand/urrea/categories-urrea/04.webp',
        link: 'https://mersolsureste.com.mx/tienda?search=URREA',
      },
      {
        title: 'HERRAMIENTAS DE CORTE',
        image: 'assets/brand/urrea/categories-urrea/05.webp',
        link: 'https://mersolsureste.com.mx/tienda?search=URREA',
      },
      {
        title: 'EQUIPO DE SEGURIDAD PERSONAL',
        image: 'assets/brand/urrea/categories-urrea/06.webp',
        link: 'https://mersolsureste.com.mx/tienda?search=URREA',
      },
      {
        title: 'FERRETERÍA Y CERRAJERÍA',
        image: 'assets/brand/urrea/categories-urrea/07.webp',
        link: 'https://mersolsureste.com.mx/tienda?search=URREA',
      },
    ],
      ...
      certificaciones: [
        {
          ...
          desc: 'Certifica la fabricación de herramientas y máquinas bajo estrictos controles de calidad, garantizando rendimiento consistente y durabilidad en cada producto.',
          icon: 'assets/brand/shared/icons/award.svg',
        },
        {
          nombre: 'NOM / ANSI',
          subtitulo: 'Normas Internacionales',
          desc: 'Verifica que todas las herramientas cumplen con las Normas Oficiales Mexicanas (NOM) y estándares internacionales (ANSI) para uso profesional seguro.',
          icon: 'assets/brand/shared/icons/award.svg',
        },
        {
          nombre: 'Hecho en México',
          subtitulo: 'Fabricación Nacional',
          desc: 'Confirma que URREA es orgullo mexicano: diseño, ingeniería y fabricación nacional que soporta las condiciones más exigentes de la industria.',
          icon: 'assets/brand/shared/icons/award.svg',
        },
      ],
      certSectionTitle: 'Calidad y Seguridad Avalada Internacionalmente',
      certSectionDesc:
        'Todas las herramientas URREA cumplen con las normativas más exigentes del mercado nacional e internacional.',
      quote: '"La herramienta del que sabe trabajar"',
      quoteAuthor: '— URREA & Mersol Sureste',
    },
    ...
    cta: {
      ...
      whatsappMessage:
        'Hola Mersol! Vengo de su página URREA. Me interesa obtener una asesoría industrial.',
    },
    ...
    footer: {
      brandLogoWhite: 'assets/brand/urrea/logos-urrea/URREA.svg',
      contactInfo: {
        phone: '+52 993 980 5654',
        email: 'ventas@mersolsureste.com.mx',
      ...
      productsCol1: [
        ...
        { label: 'Organización y Almacenamiento', url: 'almacenamiento' },
        { label: 'Herramientas Neumáticas', url: 'neumaticas' },
        { label: 'Equipos de Diagnóstico', url: 'diagnostico' },
      ],
      productsCol2: [
        { label: 'Herramientas de Corte', url: 'corte' },
        { label: 'Equipo de Seguridad Personal', url: 'seguridad' },
        { label: 'Ferretería y Cerrajería', url: 'ferreteria' },
      ],
      socialNetworks: [
  ...
  // Constructor de la landing-page URREA
  constructor(
